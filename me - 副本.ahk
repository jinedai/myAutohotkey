...
Space & o::
    ...
    if ctlState
    {
         ...
         if var_x < -40
         {
              WinMove, A,,-SCREENWIDTH2-8,a_screenheight-SCREENHEIGHT2-2,SCREENWIDTH2 + 16,SCREENHEIGHT2 - 35
         }    
         else
         {
              WinMove,A,,-8,-2,a_screenwidth + 16,a_screenheight -35
         }
    }else{
        Send #{right}
    }
...
CapsLock & u::Activate("pycharm64.exe","pycharm")
CapsLock & i::Activate("goland64.exe","goland")
